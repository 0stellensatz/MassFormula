...
- **Mathlib is used without restriction.** This project sets no preliminary boundary of its own: any Mathlib lemma may enter any proof, and the shortest available route is the right one.
